...
### 💡 What I'm Up To
- 🎵 Converting grayscale **video into music** for the visually impaired using Hilbert Curves 🔁 Sound
- 🐛 Debugging research bugs + emotional ones (with snacks and soft music)
...
Tools: Jupyter, VSCode, GitHub, SublimeText, R Studio, Google Collab
